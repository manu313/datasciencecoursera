...
newread0 <- read.csv("C:/Users/i81146/Dropbox/MJU_XWR/Code/DatascienceCoursera/R/week2/specdata/001.csv", header=TRUE)
newRead2 <- read.csv("C:/Users/i81146/Dropbox/MJU_XWR/Code/DatascienceCoursera/R/week2/specdata/002.csv", header=TRUE)
